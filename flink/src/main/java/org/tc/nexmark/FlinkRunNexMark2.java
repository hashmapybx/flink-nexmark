...
public class FlinkRunNexMark2 {
    private static Logger LOG = LoggerFactory.getLogger(FlinkRunNexMark2.class);
    public static void main(String[] args) throws Exception {
        ...
        streamTableEnvironment.executeSql("INSERT INTO discard_sink\n" +
                ...
                "        bid \n" +
                "    WHERE\n" +
                "        MOD(auction, 123) = 0;").print();

//        executionEnvironment.execute("write query2");
