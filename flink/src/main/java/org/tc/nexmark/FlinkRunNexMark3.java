...
public class FlinkRunNexMark3 {
    private static Logger LOG = LoggerFactory.getLogger(FlinkRunNexMark3.class);
    public static void main(String[] args) throws Exception {
        ...
        streamTableEnvironment.executeSql("CREATE TEMPORARY TABLE nexmark_table(  \n" +
                ...
                "    'bid.proportion' = '92'\n" +
                "); \n");
        streamTableEnvironment.executeSql("CREATE TEMPORARY TABLE discard_sink (name VARCHAR, city VARCHAR, state VARCHAR, id BIGINT) \n" +
...
//        executionEnvironment.execute("write query3");
